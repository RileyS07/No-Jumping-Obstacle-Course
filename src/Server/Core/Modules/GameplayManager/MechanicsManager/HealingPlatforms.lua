...
function gameplayMechanicManager.SimulateHealingPlatform(player, healingPlatform)
    ...
    for index = 1, (healingPlatform:GetAttribute("Duration") or script:GetAttribute("DefaultDuration") or 1)*(healingPlatform:GetAttribute("Speed") or script:GetAttribute("DefaultSpeed") or 1) do
        ...
        wait(1/(healingPlatform:GetAttribute("Duration") or script:GetAttribute("DefaultDuration") or 1))
    end
